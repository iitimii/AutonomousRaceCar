...
def generate_launch_description():
    ...
    racecar_description_prefix = get_package_prefix('racecar_description')

    model_path = os.path.join(racecar_description_dir, 'models')
    model_path += os.pathsep + os.path.join(racecar_description_prefix, 'share')
    ...
    spawn_robot = Node(
        ...
        arguments=['-entity', 'racecar', '-topic', 'robot_description', '-timeout', '150'],
        output='screen'
    )
